...
df = pd.read_csv(
    'https://raw.githubusercontent.com/MohitChoudhary23/Sales-Prediction/main/links.csv')
# list of links
links = list(df['Links'])
video_title = []
video_date = []
...
transcripts_csv = pd.DataFrame(list_with_transcripts, columns=[
                               'title', 'date', 'link', 'transcript'])
